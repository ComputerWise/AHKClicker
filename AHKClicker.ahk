...
global IBNames     := ["Home", "Grid 3", "Corel", "Settings"]
...
Gui, Add, Button, 30 ym  w75 h30 0x100 hWndhBTN01 gMN_SELECT vMN_TAB_1, % "  " IBNames[1]
ImageButton.Create(hBTN01, IBTabClrStyles*)

Gui, Add, Button, 30 y+0 w75 h30 0x100 hWndhBTN02 gMN_SELECT vMN_TAB_2, % "  " IBNames[2]
ImageButton.Create(hBTN02, IBTabClrStyles*)

Gui, Add, Button, 30 y+0 w75 h30 0x100 hWndhBTN03 gMN_SELECT vMN_TAB_3, % "  " IBNames[3]
ImageButton.Create(hBTN03, IBTabClrStyles*)

Gui, Add, Button, 30 y+0 w75 h30 0x100 hWndhBTN04 gMN_SELECT vMN_TAB_4, % "  " IBNames[4]
